...
public class FileSystem {
    ...
    public static Dir getCurrentDir(){return FileSystem.getDir(System.getProperty("user.dir"));}
    public static Dir getHomeDir(){return FileSystem.getDir(System.getProperty("user.home"));}
    public static Dir getDir(String path){return getDir(new java.io.File(path));}
    ...
    public static Node getNode(java.io.File file){
    ...
    public static Dir getDir(java.io.File file){return getNode(file).asDir();}
    public static File getFile(java.io.File file){return getNode(file).asFile();}
